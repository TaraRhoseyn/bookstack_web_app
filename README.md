...
4. [Technologies used](#technologies-used)
    ...
    4. [Workspace and version control](#workspace-and-version-control)
5. [Resources](#resources)
    1. [Design resources](#design-resources)
    2. [Testing resources](#testing-resources)
    3. [General resources](#general-resources)
6. [Testing](#testing)
    1. [Validation](#validation)
        ...
        6. [Performing tests on various devices](#performing-tests-on-various-devices)
    2. [Testing user stories](#testing-user-stories)
7. [Bugs](#bugs)
    1. [Bugs found and resolved during development](#bugs-found-and-resolved-during-development)
    2. [Fixes required for validation purposes](#fixes-required-for-validation-purposes)
